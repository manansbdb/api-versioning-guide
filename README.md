...
<p align="center">
  <strong>EN</strong> Practical notes on API versioning strategies.<br/>
  <strong>PT</strong> Notas práticas sobre estratégias de versionamento de APIs (URL, header, content negotiation).
</p>
...
| English | Português |
|---------|-----------|
| Practical notes on API versioning strategies. | Notas práticas sobre estratégias de versionamento de APIs (URL, header, content negotiation). |
